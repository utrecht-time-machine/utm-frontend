...
!(function (e, t) {
      ...
      for (var i = [], l = Array.from(t); l.length; ) {
        ...
        if ("SLOT" === u.tagName) {
          var c = u.assignedElements(),
            d = e(c.length ? c : u.children, !0, a);
          a.flatten
            ? i.push.apply(i, d)
            : i.push({ scopeParent: u, candidates: d });
        } else {
          r.call(u, n) && a.filter(u) && (o || !t.includes(u)) && i.push(u);
          var f =
              u.shadowRoot ||
              ("function" == typeof a.getShadowRoot && a.getShadowRoot(u)),
            s = !a.shadowRootFilter || a.shadowRootFilter(u);
          if (f && s) {
            var p = e(!0 === f ? u.children : f.children, !0, a);
            a.flatten
              ? i.push.apply(i, p)
              : i.push({ scopeParent: u, candidates: p });
        ...
        if ("function" == typeof o) {
          for (var l = e; e; ) {
            var u = e.parentElement,
              c = a(e);
            if (u && !u.shadowRoot && !0 === o(u)) return s(e);
            e = e.assignedSlot
              ? e.assignedSlot
              : u || c === e.ownerDocument
              ? u
  ...
  (e.focusable = function (e, t) {
    return (t = t || {}).getShadowRoot
      ...
      : i(e, t.includeContainer, h.bind(null, t));
  }),
    (e.isFocusable = function (e, t) {
      if (((t = t || {}), !e)) throw new Error("No node provided");
      return !1 !== r.call(e, g) && h(t, e);
    }),
    (e.isTabbable = function (e, t) {
      if (((t = t || {}), !e)) throw new Error("No node provided");
      return !1 !== r.call(e, n) && m(t, e);
    }),
    (e.tabbable = function (e, t) {
      ...
      return (
        (n = (t = t || {}).getShadowRoot
          ...
          : i(e, t.includeContainer, m.bind(null, t))),
        y(n)
      );
    }),
...
jQuery(".menu-az-btn>a").click(function () {
  jQuery("body").toggleClass("menu-az-on");
  if (jQuery("body").hasClass("menu-az-on")) {
    jQuery(".menu-az>div").scrollTop(0);
  }
});

//menu az view

jQuery(".az-view-nav").click(function () {
  var n = jQuery(this);
  n.attr("data-id", n.attr("data-id") == "a" ? "b" : "a");
  n.parents(".menu-az")
    .find(".az-view")
    .removeClass("on")
    .filter('[data-id="' + n.attr("data-id") + '"]')
    .addClass("on");
});

//custom audio player

function audio_player_ini() {
  jQuery(function () {
...
function dock_story_end() {
  jQuery("body").removeClass("dock-story-on");
}
function dock_story(n) {
  jQuery(".map-spin").removeClass("hide");
  var u = drupalSettings.path.baseUrl + "dock/story/" + n;
  var d = jQuery("#map_dock_story");
  window.xhr = jQuery
    .get(u)
    .done(function (r) {
      d.html(r.data);
      audio_player_ini();
      jQuery("body").addClass("dock-story-on");
      setTimeout(function () {
        jQuery(".map-spin").addClass("hide");
      }, 200);
    })
...
var saved_path = false;
jQuery(document).on("click", "a[data-story-id]", function (e) {
  e.preventDefault();
  var n = jQuery(this);
  dock_story(n.attr("data-story-id"));
});
jQuery(document).on("click", "a.dock-story-end", function () {
  dock_story_end();
});

//route start

jQuery(document).on("click", "#route_start", function () {
  jQuery("#nav_menu li:not(.is-home)").eq(0).find("a").trigger("click");
});

//fold

jQuery(document).on("click", ".fold a", function () {
  var n = jQuery(this).siblings(".fold-toggle");
  if (n.hasClass("fold-toggle-hidden")) {
    n.slide_down_transition();
    jQuery(this).addClass("on");
  } else {
    n.slide_up_transition();
...
jQuery.fn.slide_up_transition = function () {
  return this.each(function () {
    var e = jQuery(this);
    e.css("max-height", "0");
    e.addClass("fold-toggle-hidden");
  });
};
jQuery.fn.slide_down_transition = function () {
  return this.each(function () {
    var e = jQuery(this);
    e.removeClass("fold-toggle-hidden");
...
!(function ($, b, c, d) {
  var a = "ontouchstart" in b,
    e = a ? "touchstart" : "mousedown",
    f = a ? "touchmove" : "mousemove",
    g = a ? "touchcancel" : "mouseup",
    h = function (b) {
      var a = Math.floor(b / 3600),
        c = Math.floor((b % 3600) / 60),
        d = Math.ceil((b % 3600) % 60);
      return (
        (0 == a
          ? ""
          : a > 0 && a.toString().length < 2
          ? "0" + a + ":"
          : a + ":") +
        (c.toString().length < 2 ? "0" + c : c) +
        ":" +
        (d.toString().length < 2 ? "0" + d : d)
      );
    },
    i = function (b) {
      ...
      return !!(
        a.canPlayType &&
        a
          .canPlayType("audio/" + b.split(".").pop().toLowerCase() + ";")
          .replace(/no/, "")
      );
    };
  $.fn.audioPlayer = function (b) {
    var b = $.extend(
        {
    ...
    for (var d in c) j[d] = b.classPrefix + "-" + c[d];
    return (
      this.each(function () {
        if ("audio" != $(this).prop("tagName").toLowerCase()) return !1;
        var k = $(this),
          o = k.attr("src"),
          l = k.get(0).getAttribute("autoplay"),
          l = "" === l || "autoplay" === l,
          m = k.get(0).getAttribute("loop"),
          m = "" === m || "loop" === m,
          n = !1;
        void 0 === o
          ? k.find("source").each(function () {
              if (void 0 !== (o = $(this).attr("src")) && i(o))
                return (n = !0), !1;
            })
          : i(o) && (n = !0);
        var c = $(
          ...
          d = n ? c.find("audio") : c.find("embed"),
          d = d.get(0);
        if (n) {
          c.find("audio").css({ width: 0, height: 0, visibility: "hidden" }),
            c.append(
              '<div class="' +
                j.time +
                " " +
          ...
          var p = c.find("." + j.bar),
            w = c.find("." + j.barPlayed),
            x = c.find("." + j.barLoaded),
            q = c.find("." + j.timeCurrent),
            r = c.find("." + j.timeDuration),
            s = c.find("." + j.volumeButton),
            t = c.find("." + j.volumeAdjust + " > div"),
            y = 0,
            z = function (b) {
              (theRealEvent = a ? b.originalEvent.touches[0] : b),
                (d.currentTime = Math.round(
                  (d.duration * (theRealEvent.pageX - p.offset().left)) /
                    p.width()
                ));
            },
            A = function (b) {
              (theRealEvent = a ? b.originalEvent.touches[0] : b),
                (d.volume = Math.abs(
                  (theRealEvent.pageX - t.offset().left) / t.width()
                ));
            },
            B = setInterval(function () {
              d.buffered.length > 0 &&
                (x.width((d.buffered.end(0) / d.duration) * 100 + "%"),
                d.buffered.end(0) >= d.duration && clearInterval(B));
            }, 100),
            u = d.volume,
            v = (d.volume = 0.111);
          Math.round(1e3 * d.volume) / 1e3 == v
            ? (d.volume = u)
            : c.addClass(j.noVolume),
            r.html("&hellip;"),
            q.text(h(0)),
            d.addEventListener("loadeddata", function () {
              r.text(h(d.duration)),
                t.find("div").width(100 * d.volume + "%"),
                (y = d.volume);
            }),
            d.addEventListener("timeupdate", function () {
              q.text(h(d.currentTime)),
                w.width((d.currentTime / d.duration) * 100 + "%");
            }),
            d.addEventListener("volumechange", function () {
              t.find("div").width(100 * d.volume + "%"),
                d.volume > 0 && c.hasClass(j.mute) && c.removeClass(j.mute),
                d.volume <= 0 && !c.hasClass(j.mute) && c.addClass(j.mute);
            }),
            d.addEventListener("ended", function () {
              c.removeClass(j.playing);
            }),
            p
              .on(e, function (a) {
                z(a),
            ...
            s.on("click", function () {
              return (
                c.hasClass(j.mute)
                  ? (c.removeClass(j.mute), (d.volume = y))
                  : (c.addClass(j.mute), (y = d.volume), (d.volume = 0)),
                !1
              );
            }),
            t
        ...
        } else c.addClass(j.mini);
        l && c.addClass(j.playing),
          c.find("." + j.playPause).on("click", function () {
            return (
              c.hasClass(j.playing)
                ? ($(this).attr("title", b.strPlay).find("a").html(b.strPlay),
                  c.removeClass(j.playing),
                  n ? d.pause() : d.Stop())
                : ($(this).attr("title", b.strPause).find("a").html(b.strPause),
                  c.addClass(j.playing),
                  n ? d.play() : d.Play()),
              !1
            );
          }),
...
!(function (e, n) {
  ...
  var n,
    ...
    s = function (e, s) {
      for (e = 0; e < r.length; )
        (s = (s = r[e++]).container || s).removeEventListener(
          "mousedown",
          s.md,
          0
        ),
          o.removeEventListener("mouseup", s.mu, 0),
          o.removeEventListener("mousemove", s.mm, 0);
      for (
        r = [].slice.call(i.getElementsByClassName("dragscroll")), e = 0;
        e < r.length;

      )
        !(function (e, r, s, l, d, c) {
          (c = e.container || e).addEventListener(
            "mousedown",
            (c.md = function (n) {
              (e.hasAttribute("nochilddrag") &&
                i.elementFromPoint(n.pageX, n.pageY) != c) ||
                ((l = 1), (r = n.clientX), (s = n.clientY), n.preventDefault());
            }),
            0
          ),
            o.addEventListener(
              ...
              (c.mm = function (o) {
                l &&
                  ...
                  ((d = e.scroller || e).scrollLeft -= n =
                    -r + (r = o.clientX)),
                  (d.scrollTop -= t = -s + (s = o.clientY)),
                  e == i.body &&
                    (((d = i.documentElement).scrollLeft -= n),
                    (d.scrollTop -= t)));
              }),
              0
            );
  ...
  "complete" == i.readyState ? s() : o.addEventListener("load", s, 0),
    (e.reset = s);
});
